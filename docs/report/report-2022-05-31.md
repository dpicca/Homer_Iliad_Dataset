...
![Histogramme du chapitre 19[^6]](images/ch19_graph.png){#fig:hist_19}
...
[^legend]: ^C^ correspond à *class*, ^op^ à *object property*, ^dp^ à *data property*, ^ap^ à *annotation property* et ^i^ à *individual*.

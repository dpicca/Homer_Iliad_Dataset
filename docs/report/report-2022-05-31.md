...
Nous avons alors opté pour utiliser l'ontologie NLP Interchange Format (NIF) qui 
...
![Usage de ObjectProperty isCorrelatedWith](https://github.com/dpicca/Homer_dialog_role_ontology/blob/develop/docs/report/images/isCorrelatedWith.png){#fig:isCorrelatedWith}
...
![Liaison entre l'émotion Anger et le Cognitive Function](https://github.com/dpicca/Homer_dialog_role_ontology/blob/develop/docs/report/images/hasEmotionalCognitiveFunction.png){#fig:anger-cognition}
...
![Les 16 combinaisons de rôles observées ainsi que leur type Myers-Briggs correspondant. Les flèches indiquent le flux naturel de la pensée, et les émotions dominantes conscientes sont en gras et commencent par une lettre majuscule[^6]](https://github.com/dpicca/Homer_dialog_role_ontology/blob/develop/docs/report/images/emotion-MBTI.png){#fig:emotion-mbti}
...
![Les règles SWRL[^6]](https://github.com/dpicca/Homer_dialog_role_ontology/blob/develop/docs/report/images/rules.png){#fig:rules-swrl}
